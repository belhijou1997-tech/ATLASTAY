# DAR SALMA – MEMORIA OPERATIVA COMPLETA
...
- Giovani viaggiatori
- Creator
- Chi cerca "vacanza bella" senza prezzi luxury

---

## VISIONE STRATEGICA

Dar Salma **non è** un semplice Airbnb o side hustle.

È:
- Primo asset reale
- Validazione del modello Marrakech
- Base per costruire brand hospitality italo-marocchino

**Obiettivo prodotto:**
- Estetico, moderno, pulito, instagrammabile
- Profittevole, sostenibile, replicabile
- Non luxury estremo, non low-cost impersonale

**Elementi identitari:**
Marocco · storytelling autentico · ospitalità · estetica · libertà · lifestyle · indipendenza geografica
...
**Unità attive:** 1  
**Fase:** Transizione Italia → Marocco (host divide il tempo tra i due paesi)

---

## TEAM LOCALE

**Bader** – figura operativa locale
- Check-in e accoglienza ospiti
- Presidio locale durante assenza dell'host
- Primo step di delega reale e test di scalabilità

**Supporti attivi:** cleaner, supporti locali, manutenzione in consolidamento  
**Obiettivo:** micro-team affidabile e leggero

---

## SETUP E INVESTIMENTO INIZIALE

**Filosofia contabile:** setup separato dall'operatività mensile

| Voce | Importo |
|------|---------|
| Affitti iniziali | ~5.220 + 5.200 + 5.200 MAD |
| Setup operativo/arredo | ~1.550 MAD |
| **Totale setup stimato** | **~4.050 MAD** |

Considerato investimento iniziale, non costo ricorrente.
...
| Metrica | Valore |
|---------|--------|
| Impressioni prima pagina | 1.304 |
| Visite annuncio | 296 |
| Impressioni → prima pagina | 43,8% |
| Ricerca → annuncio | 22,70% |
...
| Visite annuncio | 483 |
| Wishlist saves | 27 |
| Impressioni → prima pagina | 43,5% |
| Ricerca → annuncio | 25,39% |
...
| 13 | Ikram Hassou | Airbnb | 17 giu | 19 giu | 2 | MAD 601,40 | 4 adulti · cancellazione flessibile ✓ |
...
| 16 | Soumia Khadiri | Airbnb | 6 lug | 23 lug | 17 | MAD 6.413,64 | 3 adulti + 1 bambino · cancellazione flessibile |
...
- **27–29 mag**: bloccati su Airbnb per Chaymae (Booking.com) ✅
- **Mustapha Chetmou**: ha cancellato · rimpiazzato da Chaymae Filahi stesse date
- **Maggio 24–25**: notti scadute vuote (2 notti perse)
- **iCal sync attivo**: confermato · delay 1–2h normale
...
- Recensioni da consolidare
- Automazione messaggi ospiti
- Pricing dinamico
- SOP pulizie e check-in
- Standard accoglienza con Bader
- Foto ottimizzate
- Upsell esperienze
- Riduzione dipendenza dall'host
...
2. Consolidare recensioni alte
3. Migliorare gestione Bader
4. Standardizzare check-in
5. SOP pulizie
6. Pricing dinamico
7. Automatizzare messaggi
8. Ridurre dipendenza dall'host
9. Validare giugno/luglio
10. Rendere il modello replicabile
...
**Focus:**
- Vita reale e costruzione del progetto
- Problemi veri
- Marocco, estetica, libertà
- Ospitalità e lifestyle autentico
...
Approccio: crescita lenta, sostenibile, strutturata, scalabile.  
No hype. No guru. No cashflow veloce.

Il mercato ha dato il **permesso di continuare** — non è una vittoria, è un segnale verde.
...
Dar Salma è:
- **Prototipo 1.0** del modello ATLASTAY
- Base concreta e primo test reale riuscito
- Early-stage ma con dati forti
